...
function cuSel(a) {
    ...
    jQuery(a.changedEl).each(function(c) {
        ...
        if (r && r["change"]) {
            $.each(r["change"], function(a, b) { s[s.length] = b; });
        }
        if (!m) {
        ...
        if (s.length) {
            $.each(s, function(a, b) { $("#" + g).bind("change", b); });
        }
    ...
    a.fn.jScrollPaneCusel = function(b) {
        ...
        return this.each(function() {
                ...
                if (m.length) {
                    m.each(function(c, e) {
                        a(this).bind("load", function() {
                            if (a.inArray(c, n) == -1) {
                                n.push(e);
                                m = a.grep(m, function(a, b) { return a != e; });
            ...
            if (r < .99) {
                ...
                var R = function(a) { Q(L(a, "Y") - G.top - K); };
                ...
                var Y = function(a) { V = L(a, "Y") - G.top - K; };
                var Z = function(b) {
                    N();
                    Y(b);
                    U = 0;
