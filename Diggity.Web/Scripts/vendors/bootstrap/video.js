...
(function(window, undefined) {
    ...
    _V_.extend({
        ...
        createTimeRange: function(start, end) { return{ length: 1, start: function() { return start; }, end: function() { return end; } }; },
        cache: {},
        guid: 1,
    ...
    _V_.Component = _V_.Class.extend({
        ...
        destroy: function() {},
        createElement: function(type, attrs) { return _V_.createElement(type || "div", attrs); },
        ...
        triggerReady: function() {
            ...
            if (this.readyQueue && this.readyQueue.length > 0) {
                this.each(this.readyQueue, function(fn) { fn.call(this); });
                this.readyQueue = [];
    ...
    _V_.Button = _V_.Control.extend({
        ...
        onClick: function() {},
        onFocus: function() { _V_.addEvent(document, "keyup", _V_.proxy(this, this.onKeyPress)); },
    ...
    _V_.FullscreenToggle = _V_.Button.extend({
        ...
        buildCSSClass: function() { return"vjs-fullscreen-control " + this._super(); },
        onClick: function() {
    ...
    _V_.SeekBar = _V_.Slider.extend({
        ...
        init: function(player, options) { this._super(player, options); },
    ...
    _V_.Player = _V_.Component.extend({
        init: function(tag, addOptions, ready) {
            ...
            if (options.controls) {
                this.ready(function() { this.initComponents(); });
            }
            this.textTracks = [];
        ...
        trackCurrentTime: function() {
            ...
            this.currentTimeInterval = setInterval(_V_.proxy(this, function() { this.triggerEvent("timeupdate"); }), 250);
        },
        ...
        techCall: function(method, arg) {
            if (!this.tech.isReady) {
                this.tech.ready(function() { this[method](arg); });
            } else {
                try {
        ...
        src: function(source) {
            if (source instanceof Array) {
                ...
                if (source instanceof Object) {
                    ...
                    if (!this.isReady) {
                        this.ready(function() { this.src(source); });
                    } else {
    ...
    if (_V_.isAndroid()) {
        if (_V_.androidVersion() < 3) {
            document.createElement("video").constructor.prototype.canPlayType = function(type) { return(type && type.toLowerCase().indexOf("video/mp4") != -1) ? "maybe" : ""; };
        }
    }
    ...
    _V_.flash.checkReady = function(tech) {
        if (tech.el.vjs_getProperty) {
            ...
            setTimeout(function() { _V_.flash.checkReady(tech); }, 50);
        }
    };
    ...
    _V_.flash.getEmbedCode = function(swf, flashVars, params, attributes) {
        ...
        attrsString = "";
        if (flashVars) {
            _V_.eachProp(flashVars, function(key, val) { flashVarsString += (key + "=" + val + "&amp;"); });
        }
